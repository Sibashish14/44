...
function draw() {
  ...
  for(var i=0;i<rocketG.length;i++){
  if(rocketG.get(i).isTouching(rocket1G)){
    rocket1.destroy();
    rocketG.get(i).addImage(blastAirImg);
    rocketG.get(i).setVelocity(0,0);
    rocketG.get(i).scale=0.25;
    rocketG.get(i).lifetime=2;
    score++;
  }
}
  for(var i=0;i<rocketG.length;i++){
  if(rocketG.get(i).isTouching(rocket2G)){
    rocket2.destroy();
    rocketG.get(i).addImage(blastAirImg);
    rocketG.get(i).setVelocity(0,0);
    rocketG.get(i).scale=0.25;
  ...
  for(var i=0;i<rocketG.length;i++){
  if(rocketG.get(i).isTouching(rocket3G)){
    rocket3.destroy();
    rocketG.get(i).addImage(blastAirImg);
    rocketG.get(i).setVelocity(0,0);
    rocketG.get(i).scale=0.25;
